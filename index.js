...
// it means that our program can access the functions that are built in too the command class from the commander package
...
// this would add a new contact in the contacts.json
